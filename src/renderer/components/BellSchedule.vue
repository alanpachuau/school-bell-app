<template>
    <div>
        <el-row :gutter="20" v-if="schedules.length">
            <el-col :span="20">
                <el-collapse v-model="activeNames">
                    <el-collapse-item title="Consistency" name="1">
                        <div>A with real life: in line with the process and logic of real life, and comply with languages and habits that the users are used to;</div>
            ...
            <el-col :span="4">
                <p style="text-align: center;margin-bottom: 30px;"><el-button size="huge" round><i class="el-icon-plus"></i> Add New</el-button></p>
            </el-col>
        </el-row>
        <div class="no-schedule" v-else>
            <h3>Okay! I believe this is the first time you've come here.</h3>
            <p>No bell schedule available at the moment! You can create new schedule now by clicking the button below.</p>
            <p><el-button @click="createFormVisible = true" size="huge" round><i class="el-icon-plus"></i> Create Schedule</el-button></p>
            <div class="block">
                <span class="demonstration">Sound Volume</span>
                <el-slider style="float: right; width: 70%; line-height: 34px;" v-model="createForm.sound1Volume"></el-slider>
            </div>
        </div>
        ...
        <el-dialog title="New Bell" width="40%" :visible.sync="createFormVisible">
            <el-form ref="editForm" :model="createForm" label-width="120px" label-position="left">
                <el-form-item prop="name" label="Name">
                    <el-input v-model="createForm.name" placeholder="Enter name to identify this bell" auto-complete="off"></el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button round>Close</el-button>
